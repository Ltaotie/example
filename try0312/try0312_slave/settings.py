...
BOT_NAME = 'try0312_slave'

SPIDER_MODULES = ['try0312_slave.spiders']
NEWSPIDER_MODULE = 'try0312_slave.spiders'
...
DOWNLOADER_MIDDLEWARES = {
   # 'try0312.middlewares.Try0312DownloaderMiddleware': 543,
    'try0312_slave.middlewares.RandomUserAgent': 542,
    'try0312_slave.middlewares.ProxyMiddleWare': 543,
}
